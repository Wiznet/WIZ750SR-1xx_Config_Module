...
void GPIO_InitializeInterrupt(void) {
    ...
    GPIO_Configuration(GPIOC, GPIO_Pin_3, GPIO_Mode_IN, PAD_AF1);
    GPIO_INT_Configuration(GPIOA, GPIO_Pin_10, Falling);
    GPIO_INT_Configuration(GPIOB, GPIO_Pin_0, Rising);
    GPIO_INT_Configuration(GPIOC, GPIO_Pin_2, Rising);
